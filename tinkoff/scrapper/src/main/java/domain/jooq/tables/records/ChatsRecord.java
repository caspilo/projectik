...
public class ChatsRecord extends UpdatableRecordImpl<ChatsRecord> implements Record2<Long, Long> {
    ...
    @Override
    @NotNull
    public ChatsRecord values(@NotNull Long value1, @NotNull Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
    ...
    public ChatsRecord(@NotNull Long id, @NotNull Long chatId) {
        super(Chats.CHATS);
     ...
     * Create a detached, initialised ChatsRecord
     */
    public ChatsRecord(domain.jooq.tables.pojos.Chats value) {
        super(Chats.CHATS);
