...
import clientBeans.GitHubClient;
import clientBeans.StackOverflowClient;
import dbController.DataBaseJDBCLinkController;
import dto_classes.DataClass;
import dto_classes.GitHubResponse;
    ...
    public void updateLinks(){
        ...
        for (int i = 0; i < links.size(); i++){
            ...
            if (URL.contains("github")) {
                ...
                GitHubResponse ghResponse = ghClient.fetchRepository(URL.split("/")[3], URL.split("/")[4]);
            ...
            if (URL.contains("stackoverflow")) {
                ...
                StackOverflowResponse soResponse = soClient.fetchQuestion(Long.parseLong(URL.split("/")[4]));
